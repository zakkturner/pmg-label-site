...
/******/ (function (modules) {
  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var IX2EngineEventTypes = _interopRequireWildcard(
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var _shared$IX2EngineActi = _shared.IX2EngineActionTypes,
        ...
        IX2_EVENT_LISTENER_ADDED =
          _shared$IX2EngineActi.IX2_EVENT_LISTENER_ADDED,
        ...
        IX2_ANIMATION_FRAME_CHANGED =
          _shared$IX2EngineActi.IX2_ANIMATION_FRAME_CHANGED,
        ...
        IX2_ELEMENT_STATE_CHANGED =
          _shared$IX2EngineActi.IX2_ELEMENT_STATE_CHANGED,
        IX2_ACTION_LIST_PLAYBACK_CHANGED =
          _shared$IX2EngineActi.IX2_ACTION_LIST_PLAYBACK_CHANGED,
        IX2_VIEWPORT_WIDTH_CHANGED =
          _shared$IX2EngineActi.IX2_VIEWPORT_WIDTH_CHANGED,
        IX2_MEDIA_QUERIES_DEFINED =
          _shared$IX2EngineActi.IX2_MEDIA_QUERIES_DEFINED;
      var _shared$IX2EngineItem = _shared.IX2EngineItemTypes,
        ...
        GENERAL_CONTINUOUS_ACTION =
          _shared$IX2EngineItem.GENERAL_CONTINUOUS_ACTION;
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var pluginMethodMap = (0, _defineProperty2["default"])(
        {},
        _IX2EngineItemTypes.PLUGIN_LOTTIE,
        {
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function handlePlaybackRequest(playback, store) {
        ...
        if (
          (actionListId && actionTypeId === GENERAL_START_ACTION) ||
      ...
      function bindEventType(_ref13) {
        ...
        (0, _forEach["default"])(eventTargets, function (elements, key) {
          ...
          if (eventAction.actionTypeId === GENERAL_CONTINUOUS_ACTION) {
            ...
            configs.forEach(function (eventConfig) {
              ...
              var parameterGroup = (0, _find["default"])(paramGroups, function (
                _ref14
              ) {
                var id = _ref14.id;
          ...
          if (
            eventAction.actionTypeId === GENERAL_START_ACTION ||
        ...
        var handleEvent = function handleEvent(nativeEvent) {
          ...
          forEachEventTarget(eventTargets, function (
            element,
            eventId,
            eventStateKey
          ) {
      ...
      function startActionGroup(_ref19) {
        ...
        var instanceDelay =
          isFirstGroup &&
          isQuickEffect(event.action && event.action.actionTypeId)
            ? event.config.delay
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var IX2_RAW_DATA_IMPORTED =
        _shared.IX2EngineActionTypes.IX2_RAW_DATA_IMPORTED;
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function createElementState(state, ref, refType, elementId, actionItem) {
        var refId =
          refType === _IX2EngineConstants.PLAIN_OBJECT
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var colorStyleProps = Object.freeze(
        ...
        (0, _defineProperty2["default"])(
          _Object$freeze,
          _IX2EngineItemTypes.STYLE_BACKGROUND_COLOR,
          _IX2EngineConstants.BACKGROUND_COLOR
        ),
        (0, _defineProperty2["default"])(
          _Object$freeze,
          _IX2EngineItemTypes.STYLE_BORDER,
          _IX2EngineConstants.BORDER_COLOR
        ),
        (0, _defineProperty2["default"])(
          _Object$freeze,
          _IX2EngineItemTypes.STYLE_TEXT_COLOR,
          _IX2EngineConstants.COLOR
        ),
        _Object$freeze)
      );
      var willChangeProps = Object.freeze(
        ...
        (0, _defineProperty2["default"])(
          ...
          _IX2EngineConstants.TRANSFORM
        ),
        (0, _defineProperty2["default"])(
          _Object$freeze2,
          _IX2EngineConstants.BACKGROUND_COLOR,
          _IX2EngineConstants.BACKGROUND
        ),
        (0, _defineProperty2["default"])(
          _Object$freeze2,
          _IX2EngineConstants.OPACITY,
          _IX2EngineConstants.OPACITY
        ),
        (0, _defineProperty2["default"])(
          _Object$freeze2,
          _IX2EngineConstants.FILTER,
          _IX2EngineConstants.FILTER
        ),
        (0, _defineProperty2["default"])(
          _Object$freeze2,
          _IX2EngineConstants.WIDTH,
          _IX2EngineConstants.WIDTH
        ),
        (0, _defineProperty2["default"])(
          _Object$freeze2,
          _IX2EngineConstants.HEIGHT,
          _IX2EngineConstants.HEIGHT
        ),
        _Object$freeze2)
      );
      ...
      function observeStore(_ref2) {
        var store = _ref2.store,
          ...
          comparator =
            _ref2$comparator === void 0 ? strictEqual : _ref2$comparator;
      ...
      function getAffectedElements(_ref3) {
        ...
        if (limitAffectedElements === _IX2EngineConstants.CHILDREN) {
          ...
          limitAffectedElements === _IX2EngineConstants.IMMEDIATE_CHILDREN
        ) {
      ...
      function getInstanceOrigin(element) {
        ...
        switch (actionTypeId) {
          ...
          case _IX2EngineItemTypes.STYLE_OPACITY:
            return {
              value: (0, _defaultTo["default"])(
                parseFloat(getStyle(element, _IX2EngineConstants.OPACITY)),
                1.0
              )
            };
          ...
          case _IX2EngineItemTypes.GENERAL_DISPLAY:
            return {
              value: (0, _defaultTo["default"])(
                getStyle(element, _IX2EngineConstants.DISPLAY),
      ...
      var getItemConfigByKey = function getItemConfigByKey(
        ...
        switch (actionTypeId) {
          case _IX2EngineItemTypes.STYLE_FILTER: {
            var filter = (0, _findLast["default"])(config.filters, function (
              _ref5
            ) {
              var type = _ref5.type;
              return type === key;
      ...
      function getStyleProp(renderType, actionTypeId) {
        return renderType === _IX2EngineConstants.RENDER_STYLE
      ...
      var transformDefaults =
        ...
        (0, _defineProperty2["default"])(
          _transformDefaults,
          _IX2EngineItemTypes.TRANSFORM_MOVE,
          Object.freeze({
            xValue: 0,
            yValue: 0,
            zValue: 0
        ...
        (0, _defineProperty2["default"])(
          _transformDefaults,
          _IX2EngineItemTypes.TRANSFORM_SCALE,
          Object.freeze({
            xValue: 1,
            yValue: 1,
            zValue: 1
        ...
        (0, _defineProperty2["default"])(
          _transformDefaults,
          _IX2EngineItemTypes.TRANSFORM_ROTATE,
          Object.freeze({
            xValue: 0,
            yValue: 0,
            zValue: 0
        ...
        (0, _defineProperty2["default"])(
          _transformDefaults,
          _IX2EngineItemTypes.TRANSFORM_SKEW,
          Object.freeze({
            xValue: 0,
            yValue: 0
          })
      ...
      function renderTransform(
        ...
        var newTransform = transformKeys
          .map(function (actionTypeId) {
            ...
            switch (actionTypeId) {
              case _IX2EngineItemTypes.TRANSFORM_MOVE:
                return ""
                  .concat(_IX2EngineConstants.TRANSLATE_3D, "(")
                  .concat(xValue)
                  .concat(xUnit, ", ")
                  .concat(yValue)
                  .concat(yUnit, ", ")
              ...
              case _IX2EngineItemTypes.TRANSFORM_SCALE:
                return ""
                  .concat(_IX2EngineConstants.SCALE_3D, "(")
                  .concat(xValue)
                  .concat(xUnit, ", ")
                  .concat(yValue)
                  .concat(yUnit, ", ")
              ...
              case _IX2EngineItemTypes.TRANSFORM_ROTATE:
                return ""
                  .concat(_IX2EngineConstants.ROTATE_X, "(")
                  .concat(xValue)
                  .concat(xUnit, ") ")
                  .concat(_IX2EngineConstants.ROTATE_Y, "(")
                  .concat(yValue)
                  .concat(yUnit, ") ")
                  .concat(_IX2EngineConstants.ROTATE_Z, "(")
                  .concat(zValue)
                  .concat(zUnit, ")");

              case _IX2EngineItemTypes.TRANSFORM_SKEW:
                return ""
                  .concat(_IX2EngineConstants.SKEW, "(")
                  .concat(xValue)
                  .concat(xUnit, ", ")
                  .concat(yValue)
                  .concat(yUnit, ")");
        ...
        if (hasDefined3dTransform(actionItem, actionState)) {
          setStyle(
            ...
            _IX2EngineConstants.PRESERVE_3D
          );
        }
      }
      ...
      function hasDefined3dTransform(_ref9, _ref10) {
        ...
        // TRANSLATE_Z
        return (
          (actionTypeId === _IX2EngineItemTypes.TRANSFORM_MOVE &&
            zValue !== undefined) || // SCALE_Z
          (actionTypeId === _IX2EngineItemTypes.TRANSFORM_SCALE &&
            zValue !== undefined) || // ROTATE_X or ROTATE_Y
          (actionTypeId === _IX2EngineItemTypes.TRANSFORM_ROTATE &&
      ...
      function parseColor(_ref11) {
        ...
        var matches = getFirstMatch(rgbMatchRegex, value).split(
          _IX2EngineConstants.COMMA_DELIMITER
        );
        return {
      ...
      function renderGeneral(element, actionItem, elementApi) {
        ...
        switch (actionItem.actionTypeId) {
          case _IX2EngineItemTypes.GENERAL_DISPLAY: {
            ...
            if (
              value === _IX2EngineConstants.FLEX &&
              _IX2BrowserSupport.IS_BROWSER_ENV
            ) {
              setStyle(
                element,
                _IX2EngineConstants.DISPLAY,
                _IX2BrowserSupport.FLEX_PREFIXED
              );
            } else {
      ...
      function addWillChange(element, prop, elementApi) {
        ...
        if (values.indexOf(validProp) === -1) {
          setStyle(
            element,
            _IX2EngineConstants.WILL_CHANGE,
            values.concat(validProp).join(_IX2EngineConstants.COMMA_DELIMITER)
          );
        }
      }
      ...
      function removeWillChange(element, prop, elementApi) {
        ...
        setStyle(
          ...
          _IX2EngineConstants.WILL_CHANGE,
          value
            .split(_IX2EngineConstants.COMMA_DELIMITER)
            .map(trim)
            .filter(function (v) {
              return v !== validProp;
            })
      ...
      function getActionListProgress(actionList, instance) {
        ...
        actionItemGroups.forEach(function (group, index) {
          ...
          var duration =
            getRenderType(actionTypeId) === _IX2EngineConstants.RENDER_GENERAL
              ? 0
              : config.duration;
      ...
      function reduceListToGroup(_ref17) {
        ...
        actionItemGroups &&
          actionItemGroups.some(function (_ref18) {
      ...
      function shouldNamespaceEventParameter(eventTypeId, _ref21) {
        ...
        return (
          (eventTypeId === _IX2EngineEventTypes.SCROLLING_IN_VIEW &&
            (basedOn === _IX2EngineEventTypes.ELEMENT || basedOn == null)) ||
          (eventTypeId === _IX2EngineEventTypes.MOUSE_MOVE &&
            basedOn === _IX2EngineEventTypes.ELEMENT)
        );
      }
      ...
      function getNamespacedParameterId(
        ...
        var namespacedParameterId =
          eventStateKey +
          _IX2EngineConstants.COLON_DELIMITER +
          continuousParameterGroupId;
      ...
      function stringifyTarget(target) {
        ...
        return (
          id +
          _IX2EngineConstants.BAR_DELIMITER +
          selector +
          _IX2EngineConstants.BAR_DELIMITER +
          useEventTarget
        );
      ...
      var ixRequest = function ixRequest() {
        ...
        if (action.type in stateKeys) {
          ...
          return (0, _timm.setIn)(
            state,
            [key],
            (0, _objectSpread2["default"])({}, action.payload)
          );
        }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var baseActivityActionGroupOptions = (0, _objectSpread2["default"])(
        {},
      ...
      var scrollIntoOutOfViewOptions = (0, _objectSpread2["default"])(
        {},
      ...
      var _default =
        ...
        (0, _defineProperty2["default"])(
          _default2,
          MOUSE_DOWN,
          (0, _objectSpread2["default"])({}, baseActionGroupOptions, {
            types: "mousedown"
          })
        ),
        (0, _defineProperty2["default"])(
        ...
        (0, _defineProperty2["default"])(
          _default2,
          PAGE_SCROLL_DOWN,
          (0, _objectSpread2["default"])({}, baseScrollActionGroupOptions, {
